...
{
    [Verb("scene", HelpText = "Add file contents to the index.")]
    ...
    [Verb("patterns", HelpText = "Add file contents to the index.")]
    public class PatternsOptions
    {
        [Option('i', "input", Required = true, HelpText = "Input patterns paths")]
        public string Input { get; set; }
    ...
    [Verb("world", HelpText = "World mapping scenes")]
    public class  WorldOptions
    {
        [Option('i', "input", Required = true, HelpText = "Input world root path")]
        public string Input { get; set; }

        [Option('o', "output", Required = true, HelpText = "output world path")]
